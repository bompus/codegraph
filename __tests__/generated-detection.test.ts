...
describe('hasGeneratedHeader — per-marker coverage (#1500)', () => {
  ...
  it('flags a bannerless tree-sitter parser.c, not the grammar\'s hand-written scanner.c', () => {
    const parser = '#include "tree_sitter/parser.h"\n\n#if defined(__GNUC__)\n#pragma GCC diagnostic ignored "-Wmissing-field-initializers"\n#endif\n\n#define LANGUAGE_VERSION 14\n#define STATE_COUNT 9\n';
    const scanner = '#include "tree_sitter/parser.h"\n#include <wctype.h>\n\nenum TokenType { AUTOMATIC_SEMICOLON };\n';
    expect(hasGeneratedHeader(parser)).toBe(true);
    expect(hasGeneratedHeader(scanner)).toBe(false);
  });
