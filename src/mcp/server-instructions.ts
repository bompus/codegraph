...
- Requested test files include matching setup and assertion statements; Vue layout questions include matching template and style regions. These source excerpts share the output budget with symbol bodies and do not imply additional graph edges.
