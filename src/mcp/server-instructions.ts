...
- Requested files include declarations matching the question alongside named bodies, including selectors and cache keys. Requested test files include matching setup and assertion statements; Vue layout questions include matching template and style regions. These excerpts share the output budget and do not imply additional graph edges.
