...
/** Languages `bindingsFile` handles: the TS/JS family, ArkTS, Python, Go, Java and Kotlin. */
const BINDINGS_LANGUAGES = new Set<string>(['typescript', 'tsx', 'javascript', 'jsx', 'arkts', 'python', 'go', 'java', 'kotlin']);
