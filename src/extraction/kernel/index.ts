...
/** Languages `bindingsFile` handles: the TS/JS family, ArkTS, Python and Go. */
const BINDINGS_LANGUAGES = new Set<string>(['typescript', 'tsx', 'javascript', 'jsx', 'arkts', 'python', 'go']);
